    ...
    public function initSchema(): void {
        $this->pdo->exec("
            ...
            CREATE TABLE IF NOT EXISTS wage_rule_sets (
                ...
                balancing_period_weeks INTEGER DEFAULT NULL CHECK(balancing_period_weeks IS NULL OR balancing_period_weeks > 0),
                ...
                holiday_calendar TEXT NOT NULL DEFAULT 'danish' CHECK(holiday_calendar IN ('danish','swedish','norwegian','german','custom')),
                breaks_paid INTEGER NOT NULL DEFAULT 0,
                default_break_duration INTEGER NOT NULL DEFAULT 30 CHECK(default_break_duration >= 0),
                -- Tier settings (Section 2.2)
                tier1_threshold REAL NOT NULL DEFAULT 3.0 CHECK(tier1_threshold >= 0),
                tier1_rate REAL NOT NULL DEFAULT 50.0 CHECK(tier1_rate >= 0),
                tier2_rate REAL NOT NULL DEFAULT 100.0 CHECK(tier2_rate >= 0),
                flat_overtime_rate REAL NOT NULL DEFAULT 50.0 CHECK(flat_overtime_rate >= 0),
                schedule_change_enabled INTEGER NOT NULL DEFAULT 1,
                schedule_change_rate REAL NOT NULL DEFAULT 50.0 CHECK(schedule_change_rate >= 0),
            ...
            CREATE TABLE IF NOT EXISTS supplement_intervals (
                ...
                rate_value REAL NOT NULL DEFAULT 0.0 CHECK(rate_value >= 0),
            ...
            CREATE TABLE IF NOT EXISTS employee_contracts (
                ...
                base_hourly_wage REAL NOT NULL CHECK(base_hourly_wage >= 0),
            ...
            CREATE TABLE IF NOT EXISTS contract_changes (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                contract_id INTEGER NOT NULL REFERENCES employee_contracts(id) ON DELETE CASCADE,
